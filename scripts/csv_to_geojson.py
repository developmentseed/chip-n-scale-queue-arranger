...
if __name__ == "__main__":
    ...
    parser.add_argument('fname_csv', type=str,
                        help='Filepath to CSV file needing conversion.')
    parser.add_argument('fname_geojson', type=str, default='results.geojson',
                        help='Filepath to save geojson file to.')
    parser.add_argument('--tile-format', type=str, default='tms',
                        help='Format of tile indices in CSV file ("tms" or "google").')
    parser.add_argument('--thresh-ind', type=int, default=1,
                        help='Optional threshold class index for including a prediction.')
    parser.add_argument('--thresh', type=float, default=0.,
                        help='Optional threshold for including a prediction.')

    args = parser.parse_args()
    convert_csv(args.fname_csv, args.fname_geojson, args.tile_format,
                args.thresh_ind, args.thresh)
